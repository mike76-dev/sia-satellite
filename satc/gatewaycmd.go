...
For example: satc gateway blocklist append 123.123.123.123 111.222.111.222 mysiahost.duckdns.org`,
	...
	For example: satc gateway blocklist clear`,
...
Accepts a list of ip addresses or domain names as individual inputs.
For example: satc gateway blocklist remove 123.123.123.123 111.222.111.222 mysiahost.duckdns.org`,
...
Accepts a list of ip addresses or domain names as individual inputs.
For example: satc gateway blocklist set 123.123.123.123 111.222.111.222 mysiahost.duckdns.org`,
...
// gatewaydisconnectcmd is the handler for the command `satc gateway remove [address]`.
...
// gatewayaddresscmd is the handler for the command `satc gateway address`.
...
// gatewaylistcmd is the handler for the command `satc gateway list`.
