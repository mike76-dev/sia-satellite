...
func (s *Server) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	if origin := r.Header.Get("Origin"); origin != "" {
		...
		w.Header().Set("Access-Control-Allow-Headers", "Accept, Content-Type, Content-Length, Accept-Encoding, X-CSRF-Token, Authorization, X-Satellite-Password")
...
func (s *Server) buildHTTPRoutes() {
	...
	router.POST("/account/settings/contracts", func(w http.ResponseWriter, req *http.Request, ps httprouter.Params) {
		s.accountSettingsContractsHandlerPOST(w, req, ps)
	})
	...
	router.POST("/auth/reset", func(w http.ResponseWriter, req *http.Request, ps httprouter.Params) {
		s.authResetHandlerPOST(w, req, ps)
	})
	...
	router.GET("/payment/address", func(w http.ResponseWriter, req *http.Request, ps httprouter.Params) {
