...
func (api *portalAPI) buildHTTPRoutes() {
	...
	router.GET("/dashboard/file", func(w http.ResponseWriter, req *http.Request, ps httprouter.Params) {
		api.fileHandlerGET(w, req, ps)
	})
	router.GET("/dashboard/address", func(w http.ResponseWriter, req *http.Request, ps httprouter.Params) {
		api.addressHandlerGET(w, req, ps)
	})
	router.POST("/dashboard/plan", func(w http.ResponseWriter, req *http.Request, ps httprouter.Params) {
		api.planHandlerPOST(w, req, ps)
	})
	router.GET("/dashboard/fees", func(w http.ResponseWriter, req *http.Request, ps httprouter.Params) {
		api.feesHandlerGET(w, req, ps)
	})
	router.GET("/dashboard/announcement", func(w http.ResponseWriter, req *http.Request, ps httprouter.Params) {
		api.announcementHandlerGET(w, req, ps)
	})
